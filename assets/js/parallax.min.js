        ...
        1: [function (require, module, exports) {
            ...
            var Parallax = function () {
                ...
                _createClass(Parallax, [{
                    key: "initialise", value: function initialise() {
                    ...
                    key: "updateLayers", value: function updateLayers() {
                    ...
                    key: "updateBounds", value: function updateBounds() {
                    ...
                    key: "queueCalibration", value: function queueCalibration(delay) {
                    ...
                    key: "calibrate", value: function calibrate(x, y) {
                        this.calibrateX = x === undefined ? this.calibrateX : x;
                        this.calibrateY = y === undefined ? this.calibrateY : y
                    }
                }, {
                    key: "invert", value: function invert(x, y) {
                        this.invertX = x === undefined ? this.invertX : x;
                        this.invertY = y === undefined ? this.invertY : y
                    }
                }, {
                    key: "friction", value: function friction(x, y) {
                        this.frictionX = x === undefined ? this.frictionX : x;
                        this.frictionY = y === undefined ? this.frictionY : y
                    }
                }, {
                    key: "scalar", value: function scalar(x, y) {
                        this.scalarX = x === undefined ? this.scalarX : x;
                        this.scalarY = y === undefined ? this.scalarY : y
                    }
                }, {
                    key: "limit", value: function limit(x, y) {
                        this.limitX = x === undefined ? this.limitX : x;
                        this.limitY = y === undefined ? this.limitY : y
                    }
                }, {
                    key: "origin", value: function origin(x, y) {
                        this.originX = x === undefined ? this.originX : x;
                        this.originY = y === undefined ? this.originY : y
                    }
                }, {
                    key: "setPosition", value: function setPosition(element, x, y) {
                    ...
                    key: "onOrientationTimer", value: function onOrientationTimer() {
                    ...
                    key: "onMotionTimer", value: function onMotionTimer() {
                    ...
                    key: "onCalibrationTimer", value: function onCalibrationTimer() {
                        this.calibrationFlag = true
                    }
                }, {
                    ...
                    key: "onAnimationFrame", value: function onAnimationFrame() {
                        this.updateBounds();
                    ...
                    key: "rotate", value: function rotate(beta, gamma) {
                        var x = (beta || event.beta || 0) / MAGIC_NUMBER, y = (gamma || event.gamma || 0) / MAGIC_NUMBER;
                    ...
                    key: "onDeviceOrientation", value: function onDeviceOrientation(event) {
                        var beta = event.beta;
                    ...
                    key: "onDeviceMotion", value: function onDeviceMotion(event) {
                    ...
                    key: "onMouseMove", value: function onMouseMove(event) {
