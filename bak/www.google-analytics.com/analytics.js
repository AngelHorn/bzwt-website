(function () {
    ...
    var oc = function () {
        ...
        1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j50", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(oc() + "/collect", a.join("&"), ua))
    };
    var h = function (a) {
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/, pc = function (a) {
        ...
        var c = M.documentElement, g = (e = M.body) &&
            e.clientWidth && e.clientHeight, ca = [];
