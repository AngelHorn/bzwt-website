(function () {
    var h = {}, mt = {}, c = {
        id: "9b3c64aa4c27ad34a8b493b4a6b6c23f",
        dm: ["gotokeep.com"],
        ...
        return function (d) {
            switch (typeof d) {
                ...
                default:
                    ...
                    n = ["{"];
                    e = mt.j.stringify;
                    for (l in d)if (Object.prototype.hasOwnProperty.call(d, l))switch (m =
                        d[l], typeof m) {
                        case "undefined":
                        case "unknown":
                        case "function":
    ...
    mt.localStorage.set = function (a, b, f) {
        ...
        try {
            window.localStorage ? (b = d.getTime() + "|" + b, window.localStorage.setItem(a, b)) : mt.localStorage.A() && (mt.localStorage.g.expires = d.toUTCString(), mt.localStorage.g.load(document.location.hostname), mt.localStorage.g.setAttribute(a, b), mt.localStorage.g.save(document.location.hostname))
        } catch (g) {
        }
    };
    ...
    (function () {
        ...
        function b() {
            ...
            if ((!n || !m) && e && k)u = s, p = +new Date; else if (n && m && (!e || !k))u = w, q += +new Date - p;
            n = e;
            m = k;
            y = setTimeout(b, 100)
        }
        ...
        function f(a) {
            var p = document, m = "";
            if (a in p)m = a; else for (var b = ["webkit", "ms", "moz", "o"], k = 0; k < b.length; k++) {
    ...
    (function () {
        ...
        var f = mt.lang, d = mt.j, g = h.B, l = h.D, n = h.ca, e = {
            p: [], z: 0, S: w, init: function () {
                e.e = 0;
                l.c("pv-b", function () {
                    e.da();
                    e.fa()
                ...
                b = b[1];
                f.d(b, "Object") && (a(b), e.e |= 16, h.b.a.nv = 0, h.b.a.st = 4, h.b.a.et = 94, h.b.a.ep = d.stringify(b), h.b.h())
                ...
                if (f.d(b, "Object")) {
                    ...
                    if (900 >= l)k.call(this, b); else for (var l = Math.ceil(l / 900), p = "block|" + Math.round(Math.random() *
    ...
    (function () {
        ...
        var b = mt.url, f = mt.W, d = mt.N, g = mt.lang, l = mt.cookie, n = mt.i, e = mt.localStorage, m = mt.sessionStorage, k = h.B, v = h.D;
        a.prototype = {
            I: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                var a =
                    w;
                this.s(document.referrer) && this.s(document.location.href) ? a = s : (a = b.Q(document.referrer), a = this.I(a || "", document.location.hostname));
                ...
                try {
                    l.set(a, b, {domain: this.G(), path: this.P(), F: d}), d ? e.set(a, b, d) : m.set(a, b)
                } catch (f) {
                }
            }, ya: function (a) {
                try {
                    l.set(a, "", {domain: this.G(), path: this.P(), F: -1}), m.remove(a), e.remove(a)
                } catch (b) {
                }
            }, Da: function () {
                var a, b, d, f, e;
                ...
                try {
                    this.Ea(), 0 === this.a.nv ? this.Ba() : this.M(".*"), h.b = this, this.ba(), v.r("pv-b"), this.Aa()
                } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id), f = -1 < document.referrer.indexOf(k.$), e = b.f(a, "jn"), g = /^heatlink$|^select$/.test(e);
                ...
                var a = this, b = m.get("Hm_unsent_" + c.id);
    ...
    (function () {
        var a = mt.i, b = mt.lang, f = mt.event, d = mt.j;
